    ...
    (unwind-protect
         (progn
           ...
           (loop :for line = (read-line-crlf https nil)
                 ...
                 ;; which causes OpenSSL to signal an error.
                 ;; Such servers expect HTTP clients to use the protocol
                 ;; information to determine how many bites to read,
                 ;; instead of relying the connection termination.)
                 ))
      (close https))))
